...
LIB = -lpng
TARGET = hw4
OBJS = objs/main.o objs/image.o objs/shape.o objs/sphere.o objs/scene.o objs/aabb.o objs/cylinder.o
...
objs/aabb.o: src/AABB.cpp include/AABB.h
	$(CPP) -c $(CPPFLAGS) $(INCLUDE) src/AABB.cpp -o objs/aabb.o
